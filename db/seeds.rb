...
RouteAccessControl.create([
  ...
  { route: 'profile#show',               level: -1 },
  { route: 'profile#edit',               level:  0 },
  { route: 'profile#update',             level:  0 },
  { route: 'account#edit',               level:  0 },
  { route: 'account#update',             level:  0 },
  { route: 'admin#langtypes_edit',       level:  1 },
  { route: 'admin#langtypes_update',     level:  1 },
